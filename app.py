...
# Load the datasets
symptoms_data = pd.read_csv('project/datasets/symptoms_diseases.csv')
precautions_data = pd.read_csv('project/datasets/disease_precautions.csv')
...
model = joblib.load('project/disease_prediction_model.pkl')
